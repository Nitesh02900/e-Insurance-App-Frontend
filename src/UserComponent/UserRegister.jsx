...
const UserRegister = () => {
  ...
  useEffect(() => {
    if (document.URL.indexOf("customer") !== -1) {
      setUser({ ...user, roles: "CUSTOMER" });
    } else if (document.URL.indexOf("bank") !== -1) {
      setUser({ ...user, roles: "BANK" });
    }
  }, []);
        ...
        >
          ...
          <div className="card-body">
            <form className="row g-3" onSubmit={saveUser}>
              ...
              <div className="col-md-6 mb-3 text-color">
                <label htmlFor="documentStatus" className="form-label">
                  <b>Document Status</b>
                </label>
                <input
                  type="text"
              ...
              <div className="mb-3 text-color">
                ...
                <div className="d-flex">
                  {[
                    { index: 1, name: 'Adhar Card' },
                    { index: 2, name: 'Pan Card' },
                    { index: 3, name: 'Voter ID' },
                  ].map(({ index, name }) => (
